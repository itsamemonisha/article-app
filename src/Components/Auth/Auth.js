            ...
            iserror = (
                <>
                    <div className="container error container-short">
                        <div className="mar-20">
                            <h6>Error Code - {this.state.error.code}</h6>
                            <h6>Error Message - {this.state.error.message}</h6>
                        </div>
                    </div>
                </>
            )
            ...
            <div className="container container-short py-5">
                ...
                <form onSubmit={this.mySubmitHandler} className="pt-4">
                    ...
                    <div className="form-group">
                        ...
                        <br></br>
                        <GoogleLogin
                            clientId="716939999501-afms22jh9qgkl8h0p5qnrual6l7p8vcp.apps.googleusercontent.com"
